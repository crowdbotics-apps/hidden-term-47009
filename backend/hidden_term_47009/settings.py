"""
Django settings for hidden_term_47009 project.
...
ROOT_URLCONF = 'hidden_term_47009.urls'
...
WSGI_APPLICATION = 'hidden_term_47009.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_term_47009 API",
    "DESCRIPTION": "API documentation for hidden_term_47009 App",
    "VERSION": "v1",
}
